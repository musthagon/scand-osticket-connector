<div class="wrap">
    ...
    <form method="post" class="validate" novalidate="novalidate">
        ...
        <table class="form-table">
            ...
            <tr>
                <th scope="row">
                    <label for="scand_osticket_config_topic">
                        <?php _e('Help Topic', SCAND_OST_CONNECTOR_TEXTDOMAIN); ?>
                    </label>
                </th>
                <td>
                    <div>
            ...
            <tr>
                <th scope="row">
                    <label for="scand_osticket_config_phone"><?php _e('Phone', SCAND_OST_CONNECTOR_TEXTDOMAIN); ?></label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="scand_osticket_config_phone_ext"><?php _e('Phone Ext', SCAND_OST_CONNECTOR_TEXTDOMAIN); ?></label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="scand_osticket_config_custom_text_field_osticket_name">
                        <?php _e('Custom text form field osTicket name', SCAND_OST_CONNECTOR_TEXTDOMAIN); ?>
                    </label>
                </th>
                <td>
                    <div>
                        <input name="scand_osticket_config[custom_text_field_osticket_name]" type="text" id="scand_osticket_config_custom_text_field_osticket_name" value="<?php echo $this->getConfig('custom_text_field_osticket_name'); ?>" class="regular-text" />
                    </div>
                </td>
            </tr>
            <tr>
                <th scope="row">
                    <label for="scand_osticket_config_custom_text_field_target_name">
                        <?php _e('Custom text form field target name', SCAND_OST_CONNECTOR_TEXTDOMAIN); ?>
                    </label>
                </th>
                <td>
                    <div>
                        <input name="scand_osticket_config[custom_text_field_target_name]" type="text" id="scand_osticket_config_custom_text_field_target_name" value="<?php echo $this->getConfig('custom_text_field_target_name'); ?>" class="regular-text" />
                    </div>
                </td>
            </tr>
            <tr>
                <th scope="row">
                    <label for="scand_osticket_config_custom_dynamic_field_osticket_name">
                        <?php _e('Custom dynamic form field osTicket name', SCAND_OST_CONNECTOR_TEXTDOMAIN); ?>
                    </label>
                </th>
                <td>
                    <div>
                        <input name="scand_osticket_config[custom_dynamic_field_osticket_name]" type="text" id="scand_osticket_config_custom_dynamic_field_osticket_name" value="<?php echo $this->getConfig('custom_dynamic_field_osticket_name'); ?>" class="regular-text" />
                    </div>
                </td>
            </tr>
            <tr>
                <th scope="row">
                    <label for="scand_osticket_config_custom_dynamic_field_target_name">
                        <?php _e('Custom dynamic form field target name', SCAND_OST_CONNECTOR_TEXTDOMAIN); ?>
                    </label>
                </th>
                <td>
                    <div>
                        <input name="scand_osticket_config[custom_dynamic_field_target_name]" type="text" id="scand_osticket_config_custom_dynamic_field_target_name" value="<?php echo $this->getConfig('custom_dynamic_field_target_name'); ?>" class="regular-text" />
                    </div>
                </td>
            </tr>
